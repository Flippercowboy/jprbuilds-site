...
function getSolisStates() {
    ...
    $states = [
        ...
        'sensor.solis_energy_this_year'               => ['state' => ($d['eYear'] ?? 0) * $kw,                                                           'unit' => 'kWh'],
        'sensor.solis_energy_total'                   => ['state' => ($d['eTotal'] ?? 0) * $kw,                                                          'unit' => 'kWh'],
        ...
        'sensor.solis_total_energy_charged'           => ['state' => ($d['battery_total_charge_energy'] ?? $d['batteryTotalChargeEnergy'] ?? 0) * $kw,       'unit' => 'kWh'],
        'sensor.solis_total_energy_discharged'        => ['state' => ($d['battery_total_discharge_energy'] ?? $d['batteryTotalDischargeEnergy'] ?? 0) * $kw, 'unit' => 'kWh'],
